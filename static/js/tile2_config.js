...
const t2_arrow_width = 40;
const t2_arrow_height = 80;
const t2_arrow_text_height = 20;
...
const t2_pie_total_height = t2_pie_offset + t2_pie_icon_size + 2 * t2_pie_vspace + 2 * t2_pie_radius + t2_pie_legend_size;
