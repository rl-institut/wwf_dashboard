...
const t6_pie_total_height = t6_pie_offset + 2 * t6_pie_radius + t6_pie_margin + t6_pie_legend_rect;

const t6_chart_height = 230;
const t6_chart_offset = 40;
const t6_chart_yaxis_width = 55;
const t6_chart_total_height = t6_chart_height + t6_chart_offset;
...
const t6_min_height = t6_pie_total_height + t6_chart_total_height + t6_icon_total_height;
